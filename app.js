(() => {
  ...
  function updateTikz() {
    ...
    const lines = ["\\begin{tikzpicture}[x=1cm,y=1cm]", `    % Generated by PFD TikZ Studio. Scale: ${state.scale}px = 1 TikZ unit.`];
  ...
  function bindEvents() {
    ...
    document.getElementById("downloadTexBtn").addEventListener("click", () => download("pfd-diagram.tex", els.tikz.value, "text/plain"));
